...
int main ()
{
  ...
  **/
  ...
  double Kp_throttle = 0.35, Kd_throttle = 0.05, Ki_throttle = 0.1, output_lim_max_throttle = 1.0;
...
//           // Update the delta time with the previous command
          ...
          **/
          ...
          desired_steer = angle_between_points(x_position, y_position, x_points[i], y_points[i]);
